== forge-test
:idprefix: id_ 
(choose one, do not modify, then add a second sentence with a brief description, starting with - "The forge-test addon enables blah blah...)
...
----
<dependency>
   <groupId>org.forge.test</groupId>
   <artifactId>forge-test</artifactId>
